...
public protocol Identifiable: CellsBuildable {
...
public typealias IdentifiableComponent = Identifiable & Component // & CellsBuildable

public extension Component where Self: Identifiable {
