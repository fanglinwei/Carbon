...
public protocol TextKey: Hashable {
...
public struct TextValues: Equatable {
    ...
    public static var none: TextValues = .init()
...
extension TextValues: Hashable {

    public func hash(into hasher: inout Hasher) {
        options.values.compactMap { $0 as? (any Hashable) }
            .forEach {
                hasher.combine($0)
            }
    }
...
internal struct OptionsKeys: Hashable {
