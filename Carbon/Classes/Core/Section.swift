...
public struct Section {
    ...
    ///   - footer: A node for footer view.
    public init<I: Hashable, C: Swift.Collection>(id: I = UniqueIdentifier(), header: ViewNode? = nil, cells: C, footer: ViewNode? = nil) where C.Element == CellNode? {
        self.init(
            id: id,
            header: header,
    ...
    ///   - header: A node for header view.
    ///   - footer: A node for footer view.
    public init<I: Hashable>(id: I = UniqueIdentifier(), header: ViewNode? = nil, footer: ViewNode? = nil) {
        self.init(
            id: id,
            header: header,
            cells: [],
    ...
    public init<I: Hashable, C: CellsBuildable>(id: I = UniqueIdentifier(), @CellsBuilder cells: () -> C) {
        self.init(
            id: id,
    ...
    ///   - cells: A closure that constructs cells.
    public init<I: Hashable, H: Component, F: Component, C: CellsBuildable>(id: I = UniqueIdentifier(), header: H?, footer: F?, @CellsBuilder cells: () -> C) {
        self.init(
            id: id,
    ...
    ///   - header: A header component.
    ///   - footer: A footer component.
    public init<I: Hashable, H: Component, F: Component>(id: I = UniqueIdentifier(), header: H?, footer: F?) {
        self.init(
            id: id,
            header: header.map(ViewNode.init),
            footer: footer.map(ViewNode.init)
    ...
    ///   - header: A header component.
    ///   - cells: A closure that constructs cells.
    public init<I: Hashable, H: Component>(id: I = UniqueIdentifier(), header: H?, @CellsBuilder cells: () -> CellsBuildable) {
        self.init(
            id: id,
            header: header.map(ViewNode.init),
            cells: cells().buildCells()
    ...
    ///   - footer: A footer component.
    ///   - cells: A closure that constructs cells.
    public init<I: Hashable, F: Component, C: CellsBuildable>(id: I = UniqueIdentifier(), footer: F?, @CellsBuilder cells: () -> C) {
        self.init(
            id: id,
            cells: cells().buildCells(),
            footer: footer.map(ViewNode.init)
    ...
    ///   - id: An identifier to be wrapped.
    ///   - header: A header component.
    public init<I: Hashable, H: Component>(id: I = UniqueIdentifier(), header: H?) {
        self.init(
            id: id,
            header: header.map(ViewNode.init)
        )
    ...
    ///   - id: An identifier to be wrapped.
    ///   - footer: A footer component.
    public init<I: Hashable, F: Component>(id: I = UniqueIdentifier(), footer: F?) {
        self.init(
            id: id,
            footer: footer.map(ViewNode.init)
        )
